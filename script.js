const i18n = {
  en: {
    ...
    proj1_name:"Restaurant", proj1_desc:"Web app for an Italian restaurant — online ordering, menu management, and real-time order status for admin.",
    proj2_name:"Toko Top Up Game", proj2_desc:"A game top-up platform with product listings, transaction flow, and an admin dashboard.",
    proj3_name:"Website Property", proj3_desc:"A clean landing page for a rental property business, showcasing available rooms with a modern layout.",
    demo_btn:"Live Demo →",
  ...
  id: {
    ...
    proj1_name:"Restaurant", proj1_desc:"Aplikasi web untuk restoran Italia — pemesanan online, manajemen menu, dan update status pesanan real-time untuk admin.",
    proj2_name:"Toko Top Up Game", proj2_desc:"Platform top-up game dengan daftar produk, alur transaksi, dan dashboard admin untuk mengelola pesanan.",
    proj3_name:"Website Property", proj3_desc:"Landing page untuk bisnis properti sewa, menampilkan kamar yang tersedia dengan tampilan modern.",
    demo_btn:"Lihat Demo →",
